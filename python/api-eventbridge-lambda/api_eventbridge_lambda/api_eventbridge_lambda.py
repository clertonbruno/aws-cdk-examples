...
class ApiEventBridgeLambdaStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        # Producer Lambda
        #
        event_producer_lambda = lambda_.Function(
            self,
            "eventProducerLambda",
            runtime=lambda_.Runtime.PYTHON_3_8,
            handler="event_producerlambda_.lambda_handler",
        ...
        event_producerlambda_.add_to_role_policy(event_policy)

        #
        # Approved Consumer1
        #
        event_consumer1_lambda = lambda_.Function(
            self,
            "eventConsumer1Lambda",
            runtime=lambda_.Runtime.PYTHON_3_8,
            handler="event_consumerlambda_.lambda_handler",
            code=lambda_.Code.from_asset("lambda"),
        )
        ...
        # Approved Consumer2
        #
        event_consumer2_lambda = lambda_.Function(
            self,
        ...
        firehose_role = iam.Role(
            self, "myRole", assumed_by=iam.ServicePrincipal("firehose.amazonaws.com")
        )
        ...
        event_consumer3_rule.add_target(
            targets.KinesisFirehoseStream(stream=event_consumer3_kinesisfirehose)
        )
